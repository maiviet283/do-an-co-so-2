...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- ửqwerwwrwreqwerqwerqwerqwerqwerqwerqwerqwerqwer -->
                ...
                <form action="" method="POST">
                    ...
                    if (isset($_POST["timkiem"])) {
                        ...
                        if ($s == "") {
                            ...
                            echo '<br>';
                            echo '<a style="color:black" href="quanlysp.php">Tất cả</a>';
                            echo "";
                        } else {
                            $conn = mysqli_connect("localhost", "root", "", "web1");
                            $sql = "SELECT * FROM hanghoa WHERE ten LIKE '%$s%'";
                            $kq = mysqli_query($conn, $sql);
                            $count = mysqli_num_rows($kq);
                            if ($count < 0) {
                                // echo "khong tim thấy kết quả với từ khóa ".$s;
                                echo 'Không tìm thấy kết quả phù hợp';
                                echo '<a href="quanlysp.php">Tất cả</a>';
                            } else {
                    ...
                    ?>
                                <table class="table table-striped" style="width: 80%;">
                                    ...
                                    while ($row =  mysqli_fetch_array($kq)) {
                                        ...
                                        echo '<td>' . $row['gia'] . '</td>';
                                        echo '<td><a style="color:black" href="suasp.php?ID=' . $row['ID'] . '">Sửa</a></td>';
                                        echo '<td><a href="xoasp.php?ID=' . $row['ID'] . '"><img style="width:23px" src="assets/xoa.jpg" ></a></td>';
                                        echo '</tr>';
                                        $stt++;
                                    }
                                    ?> <?php
                            ...
                            <?php
                                ...
                                while ($row1 =  mysqli_fetch_array($kq1)) {
                                    ...
                                    echo '<td>' . $row1['gia'] . '</td>';
                                    echo '<td><a style="color:black" href="suasp.php?ID=' . $row1['ID'] . '">Sửa</a></td>';
                                    echo '<td><a href="xoasp.php?ID=' . $row1['ID'] . '"><img style="width:23px" src="assets/xoa.jpg" ></a></td>';
                                    echo '</tr>';
                                    $stt++;
                                }
                            }
        ...
        <center>
            <p><i><b><a style="color:black" href="themsp.php">Thêm Sản Phẩm</a></b></i></p>
        </center>
        <div id="footer">
            <div class="box">
                <div class="logo">
