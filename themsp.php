...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO hanghoa (ten,noidung,gia) VALUE ('$ten','$noidung','$gia')";
        ...
        <form action="themsp.php" method="POST">
            <table class="table table-striped" style="width: 80%;">
                ...
                <thead>
                    <tr>
                        <th>Tên Sản Phẩm</th>
                        <td><input style="width: 500px; " type="text" name="ten"></td>
                    </tr>

                    <tr>
                        <th style="padding-bottom:150px ;">Mô Tả</th>
                        <td><textarea style="width: 500px;" cols="30" rows="7" name="noidung"></textarea></td>
                    </tr>

                    <tr>
                        <th>Đơn giá (VNĐ)</th>
                        <td><input style="width: 500px;" type="text" name="gia"></td>
                    </tr>
                    <tr>
                        <th>Thêm</th>
                        <td><input style="background-color: #58257b;color: white;padding: 9px 18px;border: none;border-radius: 4px;cursor: pointer;" type="submit" id="ADD" value="ADD"></td>
                    </tr>
                </thead>
            </table>
        </form>
